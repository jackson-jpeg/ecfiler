...
export function CommandPalette() {
  ...
  const commands: Command[] = [
    ...
    { id: "courts", label: "Court Directory", description: `Search ${COURT_COUNT} federal courts`, action: () => router.push("/courts"), icon: "M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21", category: "Tools" },
