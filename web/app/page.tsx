      ...
      <section className="relative bg-[#0f1f35] py-16 sm:py-20">
        ...
        <div className="relative max-w-5xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-[14px] sm:text-[16px] text-white/50 mt-2 max-w-lg mx-auto">Watch AI analyze a motion, verify it with 3 safety passes, and stage it for filing.</p>
          </div>
          <InteractiveDemo />
        </div>
      </section>
