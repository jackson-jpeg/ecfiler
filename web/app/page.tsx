    ...
    <div ref={pageRef} className="min-h-screen bg-[#fafaf8]">
      ...
      <nav className="bg-white/90 backdrop-blur-md border-b border-[#e8e5e0] sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-[14px]">
            <Link href="/tools" className="text-[#525252] hover:text-[#1a1a1a] transition font-medium">Free Tools</Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-[#e8e5e0] bg-white px-5 py-4 flex flex-col gap-4 text-[14px]">
            <Link href="/tools" onClick={() => setMobileMenuOpen(false)} className="text-[#525252] hover:text-[#1a1a1a] transition font-medium">Free Tools</Link>
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 sm:pt-28 pb-16 sm:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[17px] sm:text-[19px] md:text-[21px] leading-[1.6] text-[#525252] mb-10 max-w-xl mx-auto">Drop a PDF. AI reads the document, extracts case number, court, event code, and filing party. Review, stage, and file it yourself &mdash; with everything validated first.</p>
      ...
      <section className="bg-[#0f1f35] border-y border-[#1e3a5f]">
        <div className="max-w-5xl mx-auto px-5 sm:px-8 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            [String(COURT_COUNT), "Federal Courts", "District, Bankruptcy, Appellate"],
            ["5-Point", "Readiness Check", "Before anything is staged"],
            ["0", "Court Passwords Held", "Credentials never touch our servers"],
      ...
      <section className="relative bg-[#0f1f35] py-16 sm:py-20">
        ...
        <div className="relative max-w-5xl mx-auto px-5 sm:px-8">
          <div className="text-center mb-10">
            <div className="text-[11px] font-bold text-white/40 uppercase tracking-[0.2em] mb-3">Product Walkthrough</div>
            <h2 className="text-[24px] sm:text-[30px] font-bold text-white tracking-tight">See how it works</h2>
            <p className="text-[14px] sm:text-[16px] text-white/50 mt-2 max-w-lg mx-auto">A scripted walkthrough with sample data — how a motion is analyzed, checked, and staged for filing.</p>
          </div>
          <InteractiveDemo />
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 max-w-5xl mx-auto">
            {[
              ...
              { n: "02", t: "AI extracts everything", d: "Case number, court, event code, filing party, docket text. Every field extracted, then run through the 5-point readiness check.", color: "from-[#b8860b] to-[#8b6508]", accent: "#b8860b" },
              { n: "03", t: "Review and file it yourself", d: "See exactly what CM/ECF will receive. Attest, and ECFiler hands you a validated filing package with a CM/ECF deep link and step-by-step instructions. You submit it on CM/ECF.", color: "from-[#15803d] to-[#166534]", accent: "#15803d" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white border-2 border-[#fecaca] rounded-2xl p-8 relative">
              ...
              <div className="mt-6 pt-5 border-t border-[#fecaca]/50 text-center">
                <span className="text-[15px] font-bold text-[#b91c1c]">Every step by hand</span>
                <span className="text-[13px] text-[#999] block mt-1">and every mistake found by the clerk</span>
              </div>
            </div>
            {/* With */}
            <div className="bg-gradient-to-br from-[#0f1f35] to-[#1e3a5f] rounded-2xl p-8 relative shadow-xl shadow-[#1e3a5f]/20">
              ...
              <div className="space-y-4 mt-2">
                {[
                  "Drop a PDF — AI reads and extracts the details",
                  "Event code matched by AI",
                  "Automatic redaction scanning",
                  "Filing fee displayed before you submit",
                  "PDF validated, PDF/A compliance checked",
              ...
              <div className="mt-6 pt-5 border-t border-white/10 text-center">
                <span className="text-[15px] font-bold text-white">One upload, one review</span>
                <span className="text-[13px] text-white/40 block mt-1">checked before the clerk ever sees it</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {[
              { t: `${COURT_COUNT} federal courts`, d: "Every district, bankruptcy, and appellate court. BAPs and special courts included.", icon: "M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21", accent: "from-[#1e3a5f] to-[#3b82f6]" },
              ...
              { t: "Sealed content refused", d: "The hosted service refuses sealed or restricted documents outright — they never reach ECFiler's servers. Redacted public versions are supported.", icon: "M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z", accent: "from-[#b45309] to-[#f59e0b]" },
              { t: "5-point readiness check", d: "PDF validity, redaction scan, case number, event code, signature block. Attorney attestation required before staging.", icon: "M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z", accent: "from-[#1e3a5f] to-[#0f2440]" },
            ].map(({ t, d, icon, accent }) => (
      ...
      <section className="bg-[#fafaf8] border-y border-[#e8e5e0]">
        <div className="max-w-5xl mx-auto px-5 sm:px-8 py-16 sm:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z", title: "Free tools, no account", desc: "Court search, event codes, fee lookup, redaction scan, PDF checks, certificate generator.", stat: "6" },
              { icon: "M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z", title: "5-point readiness check", desc: "Nothing is staged without PDF validity, redaction, case number, event code, and signature checks.", stat: "5" },
              { icon: "M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z", title: "Your credentials, never here", desc: "Filing credentials stay in your machine's keyring. ECFiler's servers never see a court password.", stat: "0" },
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8 py-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-[12px] text-[#8a8a8a] font-medium">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
              {["Claude AI", "Playwright (local CLI)", "Next.js"].map((t) => (
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-[#0f1f35] to-[#1e3a5f] rounded-2xl p-8 relative overflow-hidden ring-2 ring-[#b8860b]/30 shadow-xl shadow-[#1e3a5f]/20">
              <div className="absolute top-4 right-4 text-[10px] px-2.5 py-1 bg-[#b8860b] text-white rounded-full font-bold shadow-lg">Coming Soon</div>
              <div className="text-[11px] font-semibold text-white/40 uppercase tracking-wide mb-2">Pro</div>
              <div className="flex items-baseline gap-1 mb-1">
                <span className="text-[42px] font-bold text-white">${PRO_PRICE}</span>
                <span className="text-[14px] text-white/40">/attorney/mo</span>
              </div>
              <div className="text-[13px] text-white/40 mb-6">Not available yet — join the waitlist for launch.</div>
              <Waitlist />
      ...
      <section className="bg-[#0f1f35] relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28 text-center">
          ...
          <p className="text-[17px] text-white/50 mb-10 max-w-md mx-auto">Free tools. {COURT_COUNT} courts. No credit card required.</p>
          <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-4 justify-center">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10">
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-8 mb-8">
            <div>
              ...
              <p className="text-[11px] text-[#8a8a8a] leading-relaxed">AI-powered federal court filing preparation. {COURT_COUNT} courts supported.</p>
            </div>
            <div>
              <div className="text-[10px] font-semibold text-[#8a8a8a] uppercase tracking-wide mb-3">Free Tools</div>
              <div className="space-y-2 text-[12px]">
                <Link href="/tools" className="block text-[#525252] hover:text-[#1a1a1a] transition">All Free Tools</Link>
                <Link href="/courts" className="block text-[#525252] hover:text-[#1a1a1a] transition">Court Search</Link>
                <Link href="/events" className="block text-[#525252] hover:text-[#1a1a1a] transition">Event Codes</Link>
                <Link href="/fees" className="block text-[#525252] hover:text-[#1a1a1a] transition">Fee Lookup</Link>
                <Link href="/redaction" className="block text-[#525252] hover:text-[#1a1a1a] transition">Redaction Scan</Link>
              </div>
            </div>
            <div>
